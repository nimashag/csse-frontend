...
// import UnassignHospitalModal from './UnassignHospitalModal';  // Import Unassign Modal
//
// interface Doctor {
//     id: string;
//     name: string;
...
//     };
//
//     const handleUnassignHospital = (doctorId: string) => {
//         setSelectedDoctorId(doctorId);
//         setShowUnassignHospitalModal(true);  // Open the unassign modal
//     };
//
...
//                                     </button>
//                                     <button
//                                         onClick={() => handleUnassignHospital(doctor.id)}  // Add unassign button
